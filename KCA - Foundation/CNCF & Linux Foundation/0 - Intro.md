...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"fontSize": 28,
			"fontFamily": 1,
			"text": "📍[[CNCF_TrailMap_latest.pdf]]",
			"rawText": "[[CNCF_TrailMap_latest.pdf]]",
			"baseline": 30,
			"textAlign": "left",
			"verticalAlign": "top",
			"containerId": null,
			"originalText": "📍[[CNCF_TrailMap_latest.pdf]]"
		}
	],
	"appState": {
		"theme": "light",
